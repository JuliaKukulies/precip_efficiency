...
for fname in files:
    ...
    total_evaporation = ds.PRW_VCD.where(ds.PRW_VCD < 0).sum('south_north').values
...
data.to_netcdf('/glade/derecho/scratch/kukulies/idealized_mcs/idealized_mcs_19_vertical_profile.nc') 
